...
public class BlockedUser extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(BlockedUser.this, "Your account is blocked due to violating our terms and condition. Please contact support for further assistance.", Toast.LENGTH_LONG).show();
